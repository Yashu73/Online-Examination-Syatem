...
<body>
	...
	<br> 
	<div>${QueAddAlert}</div>
	<form name="form" class="form-group"	action="<%=request.getContextPath()%>/ReportSetController?action=NonDeclared" method="post">
...
<hr/>
<b>Title : Non Declared exam set Details.</b>
<hr/>
 </div>
</tr> 
  <thead>
  ...
  <th>Student Id</th>
    ...
    <th>Subjects</th>      
     <th>Marks Total</th>
       ...
       <tbody>
					<c:forEach var="subwiserpt" items="${NonDeclaredS}">
					<tr>
