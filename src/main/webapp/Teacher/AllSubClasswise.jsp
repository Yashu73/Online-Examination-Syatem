...
<body>
	...
	<br> 
	<div>${QueAddAlert}</div>
	<form name="form" class="form-group"	action="<%=request.getContextPath()%>/ReportSetController?action=AllSubClasswise" method="post">
...
<hr/>
<b>Title : Class wise All Subject Result.</b>
<hr/>
 </div>
...
<input type="button" id="Print" value="Print" style="margin-left:1300px; width:50px;  border-radius:6px;  height:40px; margin-top:90px;
