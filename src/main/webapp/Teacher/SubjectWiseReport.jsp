...
<body>
	...
	<br> 
	<div>${QueAddAlert}</div>
	<form name="form" class="form-group"	action="<%=request.getContextPath()%>/ReportSetController?action=subwise" method="post">
  ...
  <th>Student Id</th>
    ...
    <th>Set </th>    
     <th>Marks/Total</th>
       ...
       <tbody>
					<c:forEach var="subwiserpt" items="${SubjectwiseRpt}">
						<tr>
