...
<body>
	<div style="background-color:#f1f1f1; margin-top: 6%; margin-left:30%; width:40%; border-radius: 15px; -moz-border-radius: 15px;">
		...
		<hr></hr>
			<table align="center">
			<tr>
			<td> <label for="usrname">Enter Current Password</label></td>  
			<td> <input type="text" id="usrname" class="form-control" name="usrname" maxlength="40" autocomplete="off" placeholder="Enter Password"></td></tr>
				 
			<tr><td> <label for="psw">Enter New Password</label></td>
			<td> <input type="password" id="psw"  class="form-control" name="psw" maxlength="40" placeholder="Enter Password"></td></tr>
				 
			<tr><td><label for="psw">Enter Confirm Password</label></td>
			<td><input type="password" id="psw" class="form-control"  name="psw" maxlength="40" placeholder="Enter Confirm Password"> </td></tr>
			</table>
